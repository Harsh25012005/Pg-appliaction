...
export default function MealsScreen() {
  ...
  const [feedbackMealType, setFeedbackMealType] = useState<'breakfast' | 'lunch' | 'dinner'>('breakfast');
  ...
  useEffect(() => {
    const calculateRemainingTime = () => {
      ...
      if (currentHour < 9) {
        ...
        [cutoffHour, cutoffMinute] = cutoffTime.breakfast.split(':').map(Number);
        mealType = 'breakfast';
      ...
      if (currentHour >= 15 && currentHour >= cutoffHour && currentMinute >= cutoffMinute) {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Card style={styles.timerCard}>
        <View style={styles.timerHeader}>
          ...
          <Text style={styles.timerTitle}>Meal Selection Countdown</Text>
        </View>
      ...
      {selectedMeal ? (
        ...
        <View style={styles.noMealContainer}>
          <Text style={styles.noMealText}>No meal information available for this date</Text>
        </View>
      )}
        ...
        <Card style={styles.feedbackCard}>
          <View style={styles.feedbackHeader}>
            ...
            <Text style={styles.feedbackTitle}>
              Rate {feedbackMealType.charAt(0).toUpperCase() + feedbackMealType.slice(1)}
            </Text>
          </View>
